...
System.registerModule("../../test/support/testStates.js", [], function() {
  "use strict";
  var __moduleName = "../../test/support/testStates.js";
  var appName = System.get("../../src/common/config.js").appName;
...
System.registerModule("../../test/auth/confirmations/confirmationsStates.js", [], function() {
  "use strict";
  var __moduleName = "../../test/auth/confirmations/confirmationsStates.js";
  var appName = System.get("../../src/common/config.js").appName;
  System.get("../../src/app/auth/auth.js");
  System.get("../../test/support/testStates.js");
  var LoggedInOnlyState = System.get("../../node_modules/xing-frontend-utils/src/xing-frontend-utils/stateClasses.js").LoggedInOnlyState;
...
System.get("../../test/auth/confirmations/confirmationsStates.js" + '');
System.registerModule("../../test/auth/passwords/passwordsControllers.js", [], function() {
  "use strict";
  var __moduleName = "../../test/auth/passwords/passwordsControllers.js";
  var appName = System.get("../../src/common/config.js").appName;
  System.get("../../src/app/auth/passwords/passwords.js");
  describe('Passwords controllers', function() {
    ...
    beforeEach(inject(function($q) {
      ...
      $authMock = {
        requestPasswordReset: function(password_request) {
          if (password_request.user.email) {
            ...
            return $q((function(resolve, reject) {
              reject({data: {errors: ["Missing Email"]}});
            }));
          }
        },
        updatePassword: function(password_update) {
          if (password_update.user.password && (password_update.user.password == password_update.user.passwordConfirmation)) {
            return $q((function(resolve, reject) {
              resolve();
            }));
          } else {
            return $q((function(resolve, reject) {
              reject({data: {errors: {passwordConfirmation: "must match password"}}});
            }));
          }
        }
      };
    ...
    describe("Passwords Request Controller", function() {
      ...
      it('should assign password request', function() {
        expect($scope.passwordRequest).toEqualData({email: ""});
      });
    ...
    describe("Passwords Update Controller", function() {
      ...
      describe("passwordUpdateSubmit", function() {
        ...
        describe("with invalid request", function() {
          ...
          it("should set the toast error message", function() {
            expect($toastMock.errorList).toHaveBeenCalledWith({passwordConfirmation: "must match password"}, "We could not update your password because:");
          });
        });
      });
    });
...
System.get("../../test/auth/passwords/passwordsControllers.js" + '');
System.registerModule("../../test/auth/passwords/passwordsStates.js", [], function() {
  "use strict";
  var __moduleName = "../../test/auth/passwords/passwordsStates.js";
  var appName = System.get("../../src/common/config.js").appName;
  System.get("../../src/app/auth/passwords/passwords.js");
  System.get("../../test/support/testStates.js");
  var LoggedInOnlyState = System.get("../../node_modules/xing-frontend-utils/src/xing-frontend-utils/stateClasses.js").LoggedInOnlyState;
...
System.get("../../test/auth/passwords/passwordsStates.js" + '');
System.registerModule("../../test/auth/registrations/registrationsControllers.js", [], function() {
  "use strict";
  var __moduleName = "../../test/auth/registrations/registrationsControllers.js";
  var appName = System.get("../../src/common/config.js").appName;
  System.get("../../src/app/auth/registrations/registrations.js");
  describe('Registrations controllers', function() {
    ...
    beforeEach(inject(function($q) {
      ...
      $authMock = {submitRegistration: function(registration) {
          if (registration.user.email && (registration.user.email == registration.user.emailConfirmation) && registration.user.password && (registration.user.password == registration.user.passwordConfirmation)) {
            return $q((function(resolve, reject) {
              resolve();
            }));
          } else {
            return $q((function(resolve, reject) {
              reject({data: {errors: {emailConfirmation: "must match email"}}});
            }));
          }
        }};
    ...
    describe("Registrations Controller", function() {
      ...
      describe("registrationSubmit", function() {
        ...
        describe("with invalid login", function() {
          ...
          it("should set the toast error message", function() {
            expect($toastMock.errorList).toHaveBeenCalledWith({emailConfirmation: "must match email"}, "We cannot process your registration because:");
          });
        });
      });
    });
...
System.get("../../test/auth/registrations/registrationsControllers.js" + '');
System.registerModule("../../test/auth/registrations/registrationsStates.js", [], function() {
  "use strict";
  var __moduleName = "../../test/auth/registrations/registrationsStates.js";
  var appName = System.get("../../src/common/config.js").appName;
  System.get("../../src/app/auth/registrations/registrations.js");
  System.get("../../test/support/testStates.js");
...
System.get("../../test/auth/registrations/registrationsStates.js" + '');
System.registerModule("../../test/auth/sessions/sessionsControllers.js", [], function() {
  "use strict";
  var __moduleName = "../../test/auth/sessions/sessionsControllers.js";
  var appName = System.get("../../src/common/config.js").appName;
  System.get("../../src/app/auth/sessions/sessions.js");
  describe('Sessions controllers', function() {
    ...
    beforeEach(inject(function($q) {
      ...
      $stateMock = {go: function(state) {}};
      spyOn($stateMock, 'go').and.callThrough();
      $authMock = {submitLogin: function(session) {
    ...
    describe("Sessions Controller", function() {
      ...
      it('should assign session', function() {
        expect($scope.session).toEqualData({
          email: "",
          password: ""
        });
      });
...
System.get("../../test/auth/sessions/sessionsControllers.js" + '');
System.registerModule("../../test/auth/sessions/sessionsStates.js", [], function() {
  "use strict";
  var __moduleName = "../../test/auth/sessions/sessionsStates.js";
  var appName = System.get("../../src/common/config.js").appName;
  System.get("../../src/app/auth/sessions/sessions.js");
  System.get("../../test/support/testStates.js");
  var LoggedInOnlyState = System.get("../../node_modules/xing-frontend-utils/src/xing-frontend-utils/stateClasses.js").LoggedInOnlyState;
...
System.get("../../test/auth/sessions/sessionsStates.js" + '');
System.registerModule("../../test/specHelper.js", [], function() {
  "use strict";
  var __moduleName = "../../test/specHelper.js";
  beforeEach(function() {
    jasmine.addMatchers({
      ...
      toBeFunction: function() {
        return {compare: function(actual) {
            return {pass: angular.isFunction(actual)};
          }};
      },
...
System.get("../../test/specHelper.js" + '');
System.registerModule("../../test/support/mockDirective.js", [], function() {
  "use strict";
  var __moduleName = "../../test/support/mockDirective.js";
  function mockDirective(directiveName, innerContent) {
  ...
  var $__default = mockDirective;
  return {get default() {
      return $__default;
    }};
});
System.get("../../test/support/mockDirective.js" + '');
System.registerModule("../../test/support/stateResolveFn.js", [], function() {
  "use strict";
  var __moduleName = "../../test/support/stateResolveFn.js";
  function resolveFn(state, property) {
    return state.resolve[property][state.resolve[property].length - 1];
  }
  var $__default = resolveFn;
  return {get default() {
      return $__default;
    }};
});
System.get("../../test/support/stateResolveFn.js" + '');
System.get("../../test/support/testStates.js" + '');
