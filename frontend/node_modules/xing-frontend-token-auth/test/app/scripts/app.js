...
(function() {
  angular.module('ngTokenAuthTestApp', ['ngSanitize', 'ui.router', 'mgcrea.ngStrap', 'angularSpinner', 'ngTokenAuthTestPartials', 'ng-token-auth']).config(function($stateProvider, $urlRouterProvider, $locationProvider, $sceProvider, $authProvider, $httpProvider) {
